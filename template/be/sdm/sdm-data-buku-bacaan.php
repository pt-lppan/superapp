					...
					<table id="fixedtable" class="table table-bordered table-responsive">
						<thead>
							<tr>
								...
								<th>Judul Buku <em class="text-danger">*</em></th>
								<th style="width:35%">Nama Pengarang<em class="text-danger">*</em></th>
...
function setupDetail(no_urut,kat,id,judul,pengarang,isDelEnabled) {
	...
	html += '<td class="align-top">';
	html += '<input type="text" class="form-control" id="judul<?=$acak?>'+kat+'_'+no_urut+'" name="det['+no_urut+'][1]" value="'+judul+'"/>';
	html += '</td>';
	html += '<td class="align-top">';
	html += '<input type="text" class="form-control" id="pengarang<?=$acak?>'+kat+'_'+no_urut+'" name="det['+no_urut+'][2]" value="'+pengarang+'"/>';
	html += '</td>';
