					...
					<table id="fixedtable" class="table table-bordered table-responsive">
						<thead>
							<tr>
								...
								<th>Acara & Penyelenggara & Lokasi<em class="text-danger">*</em></th>
								
								<th  style="width:15%">Tahun<em class="text-danger">*</em></th>
...
function setupDetail(no_urut,kat,id,acara,penyelenggara,lokasi,tahun,isDelEnabled) {
	...
	html += '<td class="align-top">';
	html += 'Acara: <input type="text" class="form-control" id="acara<?=$acak?>'+kat+'_'+no_urut+'" name="det['+no_urut+'][1]" value="'+acara+'"/>';
	...
	html += 'Lokasi dan Peserta: <input type="text" class="form-control" id="lokasi<?=$acak?>'+kat+'_'+no_urut+'" name="det['+no_urut+'][3]" value="'+lokasi+'"/>';
	html += '</td>';
	
	html += '<td class="align-top">';
	html += '<input type="text" class="form-control" id="tahun<?=$acak?>'+kat+'_'+no_urut+'" name="det['+no_urut+'][4]" value="'+tahun+'" alt="tahun"  autocomplete="off" />';
	html += '</td>';
