<ul class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<span>Penghargaan Masa Kerja</span>
	</li>
</ul>
			...
			<div class="element-box">
				...
				<div class="element-box-content">
					<form method="get" action="<?=$targetpage?>">
						...
						<div class="form-group row">
							<label class="col-sm-2 col-form-label" for="stat">Status Karyawan</label>
							<div class="col-sm-4">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="data">
							<div id="stable_con" class="element-box-content" style="overflow:auto;border:1px solid #ccc;">
								<table id="stable" class="tablesorter table table-bordered table-sm" style="width:100%;">
						...
						<div class="tab-pane" id="file">
							...
							<a class="btn btn-primary" style="display:none;" download="masa_kerja.xls" id="downloadlink">download file</a>
						</div>
					</div>
				</div>
			</div>
