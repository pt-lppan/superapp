<ul class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<span>Monitoring Updating Data</span>
	</li>
</ul>
				...
				<div class="element-box-content">
					<form method="get" action="<?=$targetpage?>">
						...
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="tanggal">terakhir diupdate &lt; tanggal</label>
							<div class="col-sm-3">
				...
				<div class="os-tabs-w">
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="file">
							...
							<a class="btn btn-primary" style="display:none;" download="monitoring_update_data_sdm.xls" id="downloadlink">download file</a>
						</div>
					</div>
				</div>
			</div>
...
$(document).ready(function(){
	...
	$('#stable').tablesorter( {sortList:[[17,0]]} );
