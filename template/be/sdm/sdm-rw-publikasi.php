					...
					<table id="fixedtable" class="table table-bordered table-responsive">
						<thead>
							<tr>
								...
								<th>Judul dan Media Publikasi<em class="text-danger">*</em></th>
...
function setupDetail(no_urut,kat,id,judul,tahun,isDelEnabled) {
	...
	html += '<td class="align-top">';
	html += '<textarea rows="2" class="form-control" id="judul<?=$acak?>'+kat+'_'+no_urut+'" name="det['+no_urut+'][1]" rows="2" onfocus="textareaOneLiner(this)">'+judul+'</textarea>';
	html += '</td>';
