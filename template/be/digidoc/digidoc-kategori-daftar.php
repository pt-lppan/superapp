		...
		<div class="element-wrapper">
			<div class="clearfix">	
				<nav class="element-actions">
					<a class="btn btn-primary" href="<?=BE_MAIN_HOST?>/digidoc/kategori/update">Tambah Data</a>
				</nav>
								...
								<td>
									<div class="input-group">
										...
										<div class="dropdown-menu dropdown-menu-right text-right">
											<a class="dropdown-item" href="<?=BE_MAIN_HOST?>/digidoc/kategori/update?id=<?=$row->id?>"><i class="os-icon os-icon-edit-1"> Update Data</i></a>
