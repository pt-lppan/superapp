<ul class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<span>Tambahan Atasan Bawahan</span>
	</li>
</ul>
				...
				<div class="element-box-content">
					<form method="get" action="<?=$targetpage?>">
						<div class="form-group row">
							<label class="col-sm-2 col-form-label" for="nama">Nama Atasan</label>
							<div class="col-sm-7">
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<?=$umum->katUI($arrSort,"sort_data","sort_data",'form-control',$sort_data)?>
							</div>
						</div>
					...
					<table class="table table-bordered table-hover table-sm">
						<thead class="thead-light">
							<tr>
								...
								<th><b>Nama Atasan</b></th>
								<th><b>Nama Bawahan (Tambahan)</b></th>
								<th style="width:1%">&nbsp;</th>
							</tr>
						</thead>
						<tbody>
							...
							$kolega = '';
							if($row->jumlah>0) {
								$sql2 = "select d.nama from sdm_user_detail d, akhlak_atasan_bawahan_tambahan k where d.id_user=k.id_bawahan and k.id_atasan='".$row->id."' order by d.nama ";
								...
								<td>
									<div class="input-group">
										...
										<div class="dropdown-menu dropdown-menu-right text-right">
											<a class="dropdown-item" href="<?=BE_MAIN_HOST?>/akhlak/master-data/konfig-tambahan-atasan-bawahan-update?id=<?=$row->id?>"><i class="os-icon os-icon-edit-1"> Update Bawahan (Tambahan)</i></a>
										</div>
									</div>
								</td>
							 </tr>
