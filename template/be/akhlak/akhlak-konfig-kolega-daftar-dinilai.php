				...
				<div class="element-box-content">
					<form method="get" action="<?=$targetpage?>">
						<div class="form-group row">
							<label class="col-sm-2 col-form-label" for="nama">Nama Dinilai</label>
							<div class="col-sm-7">
				...
				<div class="element-box-content table-responsive">
					<table class="table table-bordered table-hover table-sm">
						...
						<tbody>
							...
							$kolega = '';
							if($row->jumlah>0) {
								$sql2 = "select d.nama from sdm_user_detail d, akhlak_kolega k where d.id_user=k.id_penilai and k.id_dinilai='".$row->id."' order by d.nama ";
								...
								<td>
									<div class="input-group">
										...
										<div class="dropdown-menu dropdown-menu-right text-right">
											<a class="dropdown-item" href="<?=BE_MAIN_HOST?>/akhlak/master-data/konfig-kolega-update-dinilai?id=<?=$row->id?>"><i class="os-icon os-icon-edit-1"> Update Kolega</i></a>
										</div>
									</div>
								</td>
							 </tr>
