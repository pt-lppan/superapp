		...
		<div class="element-wrapper">
			<div class="clearfix">	
				<nav class="element-actions">
					<a class="btn btn-primary" href="<?=BE_MAIN_HOST?>/manpro/master-data/klien-update">Tambah Data</a>
				</nav>
			...
			<div class="element-box">
				...
				<div class="element-box-content">
					<form method="get" action="<?=$targetpage?>">
						...
						<div class="form-group row">
							<label class="col-sm-2 col-form-label" for="sort">Urutkan Data</label>
							<div class="col-sm-3">
								<?=$umum->katUI($arrSort,"sort","sort",'form-control',$sort)?>
							</div>
						</div>
					...
					<table class="table table-bordered table-hover table-sm">
						<thead class="thead-light">
							<tr>
								...
								<th style="width:15%"><b>Inisial</b></th>
								<th><b>Nama</b></th>
								<th><b>No Telepon</b></th>
								<th style="width:1%">ID&nbsp;AgroNow</th>
								<th style="width:1%">&nbsp;</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td><?=$row->nama?></td>
								<td><?=$row->telp?></td>
								<td><?=$row->id_agronow?></td>
								<td>
									<div class="input-group">
										<button class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown">Aksi</button>
										<div class="dropdown-menu dropdown-menu-right text-right">
											<a class="dropdown-item" href="<?=BE_MAIN_HOST?>/manpro/master-data/klien-update?id=<?=$row->id?>"><i class="os-icon os-icon-edit-1"> Update Data</i></a>
