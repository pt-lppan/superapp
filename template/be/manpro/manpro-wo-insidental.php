<ul class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<span>Daftar WO Khusus<!--Insidental--></span>
	</li>
</ul>
		...
		<div class="element-wrapper">
			<div class="clearfix">	
				<nav class="element-actions">
					<a class="btn btn-primary" href="<?=BE_MAIN_HOST?>/manpro/proyek/wo-insidental-update">Tambah Work Order</a>
				</nav>
				...
				<div class="element-box-content table-responsive">
					<table class="table table-bordered table-hover table-sm">
						...
						<tbody>
							...
							// pelaksana
							$pelaksana_ui = '';
							$sql2 = "select d.nama from sdm_user_detail d, wo_insidental_pelaksana p where p.id_wo_insidental='".$row->id."' and p.id_user=d.id_user order by d.nama ";
							$data2= $manpro->doQuery($sql2,0,'object');
							foreach($data2 as $row2) {
								$pelaksana_ui .= '<span class="badge badge-primary">'.$row2->nama.'</span> ';
							}
								...
								<td>
									...
									<div class="input-group">
										...
										<div class="dropdown-menu dropdown-menu-right text-right">
											<a class="dropdown-item" href="<?=BE_MAIN_HOST?>/manpro/proyek/wo-insidental-update?id=<?=$row->id?>"><i class="os-icon os-icon-edit-1"> Update Data</i></a>
											<a class="dropdown-item" href="<?=BE_MAIN_HOST?>/manpro/proyek/wo-insidental-kunci?id=<?=$row->id?>"><i class="os-icon os-icon-alert-octagon"> Update Status Data</i></a>
