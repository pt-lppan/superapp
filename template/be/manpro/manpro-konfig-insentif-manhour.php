<ul class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<span>Konfigurasi Insentif Manhour</span>
	</li>
</ul>
		...
		<div class="element-wrapper">
			<div class="clearfix">	
				<nav class="element-actions">
					<a class="btn btn-primary" href="<?=BE_MAIN_HOST?>/manpro/master-data/konfig-insentif-manhour-update">Tambah Data</a>
				</nav>
				...
				<div class="element-box-content table-responsive">
					<table class="table table-bordered table-hover table-sm">
						...
						<tbody>
							...
							$data2 = $manpro->getData('konfig_manhour',$param);
							foreach($data2 as $row2) {
								$konfig .= '<span class="badge badge-secondary">'.$row2->label.': '.$umum->reformatHarga($row2->nominal_bulanan).'</span> ';
							}
							?>
							<tr>
								<td><?=$i?>.</td>
								...
								<td>
									<div class="input-group">
										...
										<div class="dropdown-menu dropdown-menu-right text-right">
											<a class="dropdown-item" href="<?=BE_MAIN_HOST?>/manpro/master-data/konfig-insentif-manhour-update?tahun=<?=$row->tahun?>"><i class="os-icon os-icon-edit-1"> Update Data</i></a>
										</div>
									</div>
								</td>
							 </tr>
