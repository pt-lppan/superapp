	...
	<div class="content-box">
		<div class="element-wrapper">
			...
			<div class="alert alert-info">
				Ini merupakan dashboard v1, digunakan sebelum data MH berubah ke format template BOP 2025.<br/>
				Max ID Proyek sebelum perubahan ke template BOP 2025: 2493.<br/>
				Data bisa jadi invalid untuk proyek yang diupdate setelah 20 Desember 2024 (Cek kolom: format_bop).
			</div>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="data">
							<div>
								<b>Catatan</b>:<br/>
								<ul>
									<li><span class="bg-success" style="padding-right:3em">&nbsp;</span> proyek sudah selesai</li>
									<li><span class="bg-info" style="padding-right:3em">&nbsp;</span> proyek belum selesai</li>
								</ul>
							</div>
						...
						<div class="tab-pane" id="file">
							...
							<a class="btn btn-primary" style="display:none;" download="summary_mh_proyek.xls" id="downloadlink">download file</a>
						</div>
					</div>
				</div>
			</div>
