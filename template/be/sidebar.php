<li class="<?=$sdm->setupCSSSidebar('external_app',0)?> <?php if($this->pageLevel1=="monitor"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>/external_app/monitor/corporate">
		<div class="icon-w"><div class="os-icon os-icon-monitor"></div></div>
		<span>Monitoring Room</span>
	</a>
</li>

<li class="has-sub-menu <?php if($this->pageLevel2=="dashboard"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-bar-chart-up"></div></div>
		<span>Dashboard</span>
	</a>
...
<li class="<?=$sdm->setupCSSSidebar('personal',0)?> has-sub-menu <?php if($this->pageLevel1=="personal"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
...
<li class="<?=$sdm->setupCSSSidebar('external_app',0)?> has-sub-menu <?php if($this->pageLevel1=="external_app" && $this->pageLevel2!="dashboard"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-shopping-cart"></div></div>
		<span>Pengadaan</span>
	</a>
	<div class="sub-menu-w">
		<div class="sub-menu-i">
...
<li class="<?=$sdm->setupCSSSidebar('presensi',0)?> has-sub-menu <?php if($this->pageLevel1=="presensi" && $this->pageLevel2!="dashboard"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-clock"></div></div>
		<span>Presensi</span>
	</a>
	<div class="sub-menu-w">
		<div class="sub-menu-i">
			<ul class="sub-menu">
				...
				<li class="<?=$sdm->setupCSSSidebar('presensi',APP_PRESENSI_KONFIG)?>"><a <?php if($this->pageLevel1=="presensi" && $this->pageLevel2=="konfig-gps"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/presensi/master-data/konfig-gps">Konfig GPS Presensi</a></li>
				<li class="<?=$sdm->setupCSSSidebar('presensi',APP_PRESENSI_KONFIG)?>"><a <?php if($this->pageLevel1=="presensi" && $this->pageLevel2=="konfig-jam-reguler"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/presensi/master-data/konfig-jam-reguler">Konfig Jam Karyawan Reguler (Pusat&amp;Jogja)</a></li>
				<li class="<?=$sdm->setupCSSSidebar('presensi',APP_PRESENSI_KONFIG)?>"><a <?php if($this->pageLevel1=="presensi" && $this->pageLevel2=="konfig-jam-reguler-medan"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/presensi/master-data/konfig-jam-reguler-medan">Konfig Jam Karyawan Reguler (Medan)</a></li>
				<li class="<?=$sdm->setupCSSSidebar('presensi',APP_PRESENSI_KONFIG)?>"><a <?php if($this->pageLevel1=="presensi" && $this->pageLevel2=="konfig-jam-reguler-poliklinik"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/presensi/master-data/konfig-jam-reguler-poliklinik">Konfig Jam Karyawan Reguler (Poliklinik)</a></li>
				<li class="<?=$sdm->setupCSSSidebar('presensi',APP_PRESENSI_KONFIG)?>"><a <?php if($this->pageLevel1=="presensi" && $this->pageLevel2=="konfig-jam-shift"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/presensi/master-data/konfig-jam-shift">Konfig Jam Karyawan Shift (Pusat&amp;Jogja)</a></li>
				<li class="<?=$sdm->setupCSSSidebar('presensi',APP_PRESENSI_KONFIG)?>"><a <?php if($this->pageLevel1=="presensi" && $this->pageLevel2=="konfig-jam-shift-medan"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/presensi/master-data/konfig-jam-shift-medan">Konfig Jam Karyawan Shift (Medan)</a></li>
			</ul>
		</div>
	</div>
</li>

<li class="<?=$sdm->setupCSSSidebar('lembur',0)?> has-sub-menu <?php if($this->pageLevel1=="lembur" && $this->pageLevel2!="dashboard"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
...
<li class="<?=$sdm->setupCSSSidebar('manpro',0)?> has-sub-menu <?php if($this->pageLevel1=="manpro" && $this->pageLevel2!="dashboard"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
...
<li class="<?=$sdm->setupCSSSidebar('sppd',0)?> has-sub-menu <?php if($this->pageLevel1=="sppd" && $this->pageLevel2!="dashboard"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-ui-92"></div></div>
		<span>SPPD</span>
	</a>
	<div class="sub-menu-w">
		<div class="sub-menu-i">
...
<li class="<?=$sdm->setupCSSSidebar('sdm',0)?> has-sub-menu <?php if($this->pageLevel1=="sdm" && $this->pageLevel2!="dashboard"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-ui-55"></div></div>
		<span>Cuti</span>
	</a>
	<div class="sub-menu-w">
		<div class="sub-menu-i">
			<ul class="sub-menu">
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="daftar"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/cuti/daftar">Daftar Cuti Karyawan</a></li>
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="administrasi"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/cuti/administrasi">Sisa Cuti Karyawan</a></li>
			</ul>
		</div>
	</div>
</li>

<li class="<?=$sdm->setupCSSSidebar('akhlak',0)?> has-sub-menu <?php if($this->pageLevel1=="akhlak" && $this->pageLevel2!="dashboard"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-sun"></div></div>
		<span>AKHLAK</span>
	</a>
	<div class="sub-menu-w">
		<div class="sub-menu-i">
...
<li class="<?=$sdm->setupCSSSidebar('digidoc',0)?> has-sub-menu <?php if($this->pageLevel1=="digidoc"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-documents-11"></div></div>
...
<li class="<?=$sdm->setupCSSSidebar('aset',0)?> has-sub-menu <?php if($this->pageLevel1=="aset"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-documents-11"></div></div>
...
<li class="<?=$sdm->setupCSSSidebar('surat',0)?> has-sub-menu <?php if($this->pageLevel1=="surat"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-mail"></div></div>
		<span>Surat</span>
	</a>
	<div class="sub-menu-w">
		<div class="sub-menu-i">
...
<li class="<?=$sdm->setupCSSSidebar('memo',0)?> has-sub-menu <?php if($this->pageLevel1=="memo"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-agenda-1"></div></div>
		<span>Memo</span>
	</a>
	<div class="sub-menu-w">
		<div class="sub-menu-i">
...
<li class="<?=$sdm->setupCSSSidebar('sdm',0)?> has-sub-menu <?php if($this->pageLevel1=="sdm"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
	...
	<div class="sub-menu-w">
		<div class="sub-menu-i">
			<ul class="sub-menu">
				...
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="unit-kerja"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/sdm/unit-kerja">Unit Kerja</a></li>
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="jabatan"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/sdm/jabatan">Jabatan</a></li>
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="karyawan"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/sdm/karyawan">Data Karyawan</a></li>
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="karyawan"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST?>/sdm/karyawan/update-mass">Update Data Massal</a></li>
				<li class="sub-header <?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><span><i class="os-icon os-icon-hash"> Struktur Data</i></span></li>
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="struktur" && $this->pageLevel3=="unitkerja"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/sdm/struktur/unit_jab">Struktur Unit Kerja &amp; Jabatan</a></li>
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="struktur" && $this->pageLevel3=="karyawan"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/sdm/struktur/karyawan">Struktur Karyawan (Atasan Bawahan)</a></li>
				...
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_KARYAWAN)?>"><a <?php if($this->pageLevel2=="konfigurasi"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/sdm/konfigurasi_update_data_karyawan">Konfigurasi Pengisian Data Karyawan</a></li>
				<li class="<?=$sdm->setupCSSSidebar('sdm',APP_SDM_UPDATEPASSWORD)?>"><a <?php if($this->pageLevel2=="update_password"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/sdm/update_password">Update Password</a></li>
			</ul>
		</div>
	</div>
</li>

<li class="<?=$sdm->setupCSSSidebar('controlpanel',0)?> has-sub-menu <?php if($this->pageLevel1=="controlpanel"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-ui-46"></div></div>
		<span>Control Panel</span>
	</a>
	<div class="sub-menu-w">
		<div class="sub-menu-i">
			<ul class="sub-menu">
				<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_CP_PENGUMUMAN)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="pengumuman"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/master-data/pengumuman">Pengumuman</a></li>
				<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_CP_KONFIG_TGL_LIBUR)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="konfig-tanggal-libur"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/master-data/konfig-tanggal-libur">Konfig Tanggal Libur</a></li>
				<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_CP_KONFIG_HARI_KERJA)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="konfig-hari-kerja"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/master-data/konfig-hari-kerja">Konfig Hari Kerja</a></li>
				<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_CP_HAK_AKSES)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="hak-akses"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/master-data/hak-akses">Hak Akses</a></li>
				<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_CP_LOG)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="log"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/log">Manajemen Log</a></li>
				<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_CP_GENERATE_TOKEN64)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="generate_token64"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/generate_token64">Generate Token64</a></li>
				<!--<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_DEV)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="access_limit"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/access_limit">Pembatasan Akses Aplikasi</a></li>-->
				<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_CP_BACKUP_DB)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="db"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/db">Backup Database</a></li>
				<li class="<?=$sdm->setupCSSSidebar('controlpanel',APP_CP_VERSI)?>"><a <?php if($this->pageLevel1=="controlpanel" && $this->pageLevel2=="versi"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/controlpanel/master-data/versi">Log Versi Superapp</a></li>
			</ul>
		</div>
	</div>
</li>

<li class="<?=$sdm->setupCSSSidebar('dev',0)?> has-sub-menu <?php if($this->pageLevel1=="dev"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-aperture"></div></div>
...
<li class="<?=$sdm->setupCSSSidebar('produk',0)?> has-sub-menu <?php if($this->pageLevel1=="produk"){echo 'active';}?>">
	<a href="<?=BE_MAIN_HOST;?>">
		<div class="icon-w"><div class="os-icon os-icon-aperture"></div></div>
	...
	<div class="sub-menu-w">
		<div class="sub-menu-i">
			<ul class="sub-menu">
			<li class="<?=$sdm->setupCSSSidebar('produk',APP_PRODUK_MANAJEMEN)?>"><a <?php if($this->pageLevel2=="pengaturan"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/produk/pengaturan">Pengaturan Produk</a></li>
			<li class="<?=$sdm->setupCSSSidebar('produk',APP_PRODUK_MANAJEMEN)?>"><a <?php if($this->pageLevel2=="daftar"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/produk/daftar">Daftar Produk</a></li>	
			<li class="<?=$sdm->setupCSSSidebar('produk',APP_PRODUK_MANAJEMEN)?>"><a <?php if($this->pageLevel2=="informasi"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/produk/informasi">Informasi Produk</a></li>			
			<li class="<?=$sdm->setupCSSSidebar('produk',APP_PRODUK_MANAJEMEN)?>"><a <?php if($this->pageLevel2=="informasi"){echo 'class="active"';}?> href="<?=BE_MAIN_HOST;?>/external_app/monitor/produk">Dashboard Looker</a></li>
		</ul>
		</div>
	</div>
</li>