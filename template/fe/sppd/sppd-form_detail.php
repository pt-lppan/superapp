...
<div class="section mt-2 mb-2">
	...
	<div class="card mb-2">
		<div class="card-header bg-hijau text-white">SPPD yang Perlu Diverifikasi</div>
		<div class="card-body">
			<div class="media">
				<div class="media-body">
					...
					<iframe class="border border-primary" style="height:500px;width:100%;" src="<?=ARR_URL_EXTERNAL_APP['sppd'].ARR_AUTH_URL_EXTERNAL_APP['sppd']['utama']?>/cetak.php?id=<?=$id_sppd?>&k=sppd_perintah&req4sa_fUngTOusitorThECTOriv=1" title=""></iframe>
