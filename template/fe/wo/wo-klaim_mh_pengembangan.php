...
<script>
function konfirm(kat_proyek,id_proyek,id_aktivitas) {
	var flag = confirm("Anda yakin ingin menghapus MH ini?");
	if(flag==false) {
		return ;
	}
	window.location.href = "<?=SITE_HOST?>/wo/hapus_klaim_mh_pengembangan?kat="+kat_proyek+"&id="+id_proyek+"&id_akt="+id_aktivitas;
}
