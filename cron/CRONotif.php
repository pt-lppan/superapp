...
require_once("/home/admin/web/".$_SERVER['HTTP_HOST']."/public_html/third_party/adodb-time.inc.php");
...
require_once("/home/admin/web/".$_SERVER['HTTP_HOST']."/public_html/core/security.class.php");
require_once("/home/admin/web/".$_SERVER['HTTP_HOST']."/public_html/class/notif.class.php");
